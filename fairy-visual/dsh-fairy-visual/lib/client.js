...
//#region src/client/constants.js
	var constants_exports = /* @__PURE__ */ __exportAll({
		...
		MASCOT_POSITIONS: () => MASCOT_POSITIONS,
		MASCOT_POSITION_ATTR: () => MASCOT_POSITION_ATTR,
		MASCOT_POSITION_LABELS: () => MASCOT_POSITION_LABELS,
		MODE_ATTR: () => MODE_ATTR,
		PALETTES: () => PALETTES,
	...
	var SETTINGS_NAMESPACE, STYLE_ID, MODE_ATTR, POWER_MODE_ATTR, THEME_ATTR, PALETTE_ATTR, PALETTES, MASCOT_POSITION_ATTR, MASCOT_POSITIONS, MASCOT_POSITION_LABELS, POWER_TOGGLE_WIDTH, POWER_TOGGLE_HEIGHT, DEFAULT, HERO_PLACEHOLDERS;
	var init_constants = __esmMin((() => {
		...
		PALETTE_ATTR = "data-dsh-fairy-palette";
		PALETTES = Object.freeze([
			"hdd",
			"ink",
			"ember"
		]);
		MASCOT_POSITION_ATTR = "data-dsh-fairy-mascot-position";
		MASCOT_POSITIONS = Object.freeze([
			"top-left",
			"top-center",
			"top-right",
			"middle-left",
		...
		MASCOT_POSITION_LABELS = Object.freeze({
			"top-left": "左上",
			"top-center": "中上",
			"top-right": "右上",
			"middle-left": "左中",
...
//#region src/client/utils.js
	var utils_exports = /* @__PURE__ */ __exportAll({
		applyMascotPosition: () => applyMascotPosition,
		deriveSessionActivity: () => deriveSessionActivity,
		normalizeMascotPosition: () => normalizeMascotPosition,
	...
	var MASCOT_POSITION_DEFAULT;
	var init_utils = __esmMin((() => {
		init_constants();
		init_comfort_detector();
		MASCOT_POSITION_DEFAULT = "center";
	}));
...
//#region src/client/style.js
	...
	function injectStyles() {
		...
		const cssSections = [];
		const appendSection = (css) => cssSections.push(css);
		appendSection(`
...
html[data-dsh-fairy-visual] [data-dsh-fairy-composer-dock="true"][data-dsh-fairy-composer-popover="true"] .dsh-fairy-composer-resizer{pointer-events:none!important}html[data-dsh-fairy-visual] [data-dsh-fairy-composer-dock="true"] [data-dsh-fairy-composer-bar-root="true"]{position:absolute!important;inset:0!important}`);
		...
		appendSection(`.dsh-fairy-toggle-group{box-sizing:border-box}`);
		appendSection(`html[data-dsh-fairy-visual][data-dsh-fairy-theme="light"] .dsh-fairy-mark[data-on=true] .dsh-fairy-mark-eye{filter:grayscale(1) brightness(.82) contrast(.9)}`);
...
html[data-dsh-fairy-visual] body :where(.dsh-fairy-session-metrics-panel,.dsh-fairy-session-metrics-item){font-weight:800!important}html[data-dsh-fairy-visual] body :where(pre,code,kbd,samp),html[data-dsh-fairy-visual] body :where(pre,code,kbd,samp) *{font-weight:400!important}html[data-dsh-fairy-visual] body :where(.dsh-fairy-hero-main,.dsh-fairy-mark-title,.dsh-fairy-toggle){font-weight:750!important}`);
		...
		appendSection(`html[data-dsh-fairy-visual] [data-dsh-fairy-composer-dock="true"] [data-dsh-fairy-palette-control="true"]{position:absolute!important;z-index:12!important;right:calc(7px + 104px + 8px)!important;top:110px!important;width:max-content!important;height:18px!important;display:flex!important;align-items:center!important;gap:2px!important;padding:2px 3px!important;box-sizing:border-box!important;border-radius:999px!important;border:0!important;background:var(--dsh-card-fill,#30353a)!important}`);
		appendSection(`html[data-dsh-fairy-visual] [data-dsh-fairy-composer-dock="true"] [data-dsh-fairy-palette-control="true"] [data-dsh-fairy-palette-button]{appearance:none!important;width:12px!important;height:12px!important;padding:0!important;border-radius:4px!important;border:1px solid var(--dsh-palette-line,rgba(255,255,255,.18))!important}`);
		appendSection(`html[data-dsh-fairy-visual] [data-dsh-fairy-composer-dock="true"] [data-dsh-fairy-palette-control="true"] [data-dsh-fairy-palette-button][data-dsh-fairy-palette-swatch="hdd"]{background:#30353a!important}html[data-dsh-fairy-visual] [data-dsh-fairy-composer-dock="true"] [data-dsh-fairy-palette-control="true"] [data-dsh-fairy-palette-button][data-dsh-fairy-palette-swatch="ink"]{background:#2b3340!important}html[data-dsh-fairy-visual] [data-dsh-fairy-composer-dock="true"] [data-dsh-fairy-palette-control="true"] [data-dsh-fairy-palette-button][data-dsh-fairy-palette-swatch="ember"]{background:#382f2b!important}`);
		appendSection(`html[data-dsh-fairy-visual] [data-dsh-fairy-composer-dock="true"] [data-dsh-fairy-palette-control="true"] [data-dsh-fairy-palette-button][aria-pressed="true"]{outline:1px solid var(--dsh-palette-accent,#7cc4ff)!important;outline-offset:1px!important}`);
		...
		appendSection(`html[data-dsh-fairy-visual] [data-dsh-fairy-composer-plan-control="true"]{box-sizing:border-box!important;border-style:solid!important;border-width:2px!important;border-color:transparent!important;border-radius:var(--dsh-fairy-keycap-radius)!important;background:linear-gradient(var(--dsh-fairy-keycap-face),var(--dsh-fairy-keycap-face)) padding-box,var(--dsh-fairy-keycap-edge) border-box!important;color:var(--dsh-fairy-keycap-text)!important;min-width:34px!important;padding:2px 8px!important;font-size:13px!important;font-weight:500!important;line-height:20px!important;box-shadow:var(--dsh-fairy-keycap-shadow)!important}html[data-dsh-fairy-visual] [data-dsh-fairy-composer-plan-control="true"]:hover:not(:disabled){color:var(--dsh-fairy-keycap-hover)!important}html[data-dsh-fairy-visual] [data-dsh-fairy-composer-plan-control="true"] svg{color:inherit!important}`);
		appendSection(`html[data-dsh-fairy-visual]{--dsh-fairy-keycap-face:#30353a;--dsh-fairy-keycap-edge:linear-gradient(135deg,#555f68 0%,#4e5861 48%,#3d444b 100%);--dsh-fairy-keycap-text:#f4f7fb;--dsh-fairy-keycap-hover:#cfe8ff;--dsh-fairy-keycap-radius:8px;--dsh-fairy-keycap-shadow:-4px -4px 9px rgba(255,255,255,.06),5px 6px 13px rgba(0,0,0,.13),inset 1px 1px 0 rgba(255,255,255,.03),inset -1px -1px 0 rgba(0,0,0,.13);--dsh-card-fill:#30353a;--dsh-card-grain-light:rgba(255,255,255,.055);--dsh-card-grain-dark:rgba(0,0,0,.038);--dsh-card-sheen-light:rgba(255,255,255,.028);--dsh-card-sheen-dark:rgba(0,0,0,.024);--dsh-card-border:linear-gradient(135deg,#555f68 0%,#4e5861 48%,#3d444b 100%);--dsh-palette-accent:#7cc4ff;--dsh-palette-text:#e8edf6;--dsh-palette-text-dim:rgba(255,255,255,.72);--dsh-palette-line:rgba(255,255,255,.18)}html[data-dsh-fairy-visual][data-dsh-fairy-palette="ink"]{--dsh-card-fill:#2b3340;--dsh-card-border:linear-gradient(135deg,#4a5768 0%,#3f4a59 100%);--dsh-card-sheen-light:rgba(255,255,255,.060);--dsh-card-sheen-dark:rgba(6,12,24,.30);--dsh-fairy-keycap-face:#2b3340;--dsh-fairy-keycap-edge:linear-gradient(135deg,#4a5768 0%,#3f4a59 100%);--dsh-fairy-keycap-text:#e6ecf6;--dsh-fairy-keycap-shadow:-4px -4px 9px rgba(255,255,255,.05),5px 5px 12px rgba(6,12,24,.34);--dsh-palette-accent:#5b8fd6;--dsh-palette-text:#e6ecf6;--dsh-palette-text-dim:#93a1bb;--dsh-palette-line:rgba(120,150,200,.22)}html[data-dsh-fairy-visual][data-dsh-fairy-palette="ember"]{--dsh-card-fill:#382f2b;--dsh-card-border:linear-gradient(135deg,#60524a 0%,#4e423b 100%);--dsh-card-sheen-light:rgba(255,236,220,.070);--dsh-card-sheen-dark:rgba(20,10,4,.32);--dsh-fairy-keycap-face:#382f2b;--dsh-fairy-keycap-edge:linear-gradient(135deg,#60524a 0%,#4e423b 100%);--dsh-fairy-keycap-text:#f4ece4;--dsh-fairy-keycap-shadow:-4px -4px 9px rgba(255,236,220,.06),5px 5px 12px rgba(20,10,4,.36);--dsh-palette-accent:#e08a4f;--dsh-palette-text:#f4ece4;--dsh-palette-text-dim:#c0aa9c;--dsh-palette-line:rgba(220,150,110,.24)}html[data-dsh-fairy-visual] [data-dsh-fairy-keycap="true"]{box-sizing:border-box!important;border-style:solid!important;border-width:2px!important;border-color:transparent!important;border-radius:var(--dsh-fairy-keycap-radius)!important;background:linear-gradient(var(--dsh-fairy-keycap-face),var(--dsh-fairy-keycap-face)) padding-box,var(--dsh-fairy-keycap-edge) border-box!important;color:var(--dsh-fairy-keycap-text)!important;box-shadow:var(--dsh-fairy-keycap-shadow)!important}html[data-dsh-fairy-visual] [data-dsh-fairy-keycap="true"]:hover:not(:disabled){color:var(--dsh-fairy-keycap-hover)!important}`);
		appendSection(`html[data-dsh-fairy-visual] [data-dsh-fairy-composer-dock="true"] [data-dsh-fairy-mascot-position-control="true"],html[data-dsh-fairy-visual] [data-dsh-fairy-composer-dock="true"] [data-dsh-fairy-palette-control="true"],html[data-dsh-fairy-visual] [data-dsh-fairy-composer-dock="true"] [data-dsh-fairy-mascot-scale-base="true"],html[data-dsh-fairy-visual] [data-dsh-fairy-composer-dock="true"] [data-dsh-fairy-mascot-animation-speed-base="true"]{pointer-events:none!important}`);
...
//#region src/client/dom-adapter.js
	var require_dom_adapter = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		const OFFICIAL_SELECTORS = Object.freeze({
			...
			conversation: "[data-slot=\"conversation\"], [data-slot=\"main.conversation\"]",
...
//#region src/client/mascot-animation-speed-control.js
	var require_mascot_animation_speed_control = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		function createMascotAnimationSpeedBase(host, controller, documentRef = document) {
			...
			const pair = existing ? {
				base: existing,
				control: existing.querySelector(`[${CONTROL_ATTR}="true"]`)
			} : build();
			if (!pair.control) {
				pair.control = build().control;
				pair.base.appendChild(pair.control);
			}
			if (pair.base.parentElement !== host) host.appendChild(pair.base);
			const paint = () => pair.control.setAttribute(POSITION_ATTR, String(positionForRate(controller?.getSnapshot?.().settings?.mascotAnimationSpeed)));
			...
			return {
				...
				dispose() {
					off?.();
					if (pair.base.parentElement === host) pair.base.remove();
				}
			};
		}
		module.exports = {
...
//#region src/client/mascot-position-control.js
	var require_mascot_position_control = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		const { MASCOT_POSITION_LABELS, MASCOT_POSITIONS } = (init_constants(), __toCommonJS(constants_exports));
...
//#endregion
//#region src/client/mascot-palette-control.js
	var require_mascot_palette_control = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		const { PALETTES } = (init_constants(), __toCommonJS(constants_exports));
		...
		function createMascotPaletteBase(host, controller, documentRef = document) {
			...
			const paint = (value) => {
				...
				for (const [name, button] of buttons) button.setAttribute("aria-pressed", String(name === current));
			};
...
//#region src/client/composer-dock.js
	var require_composer_dock = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		const { createMascotPaletteBase } = require_mascot_palette_control();
		const MARKER_ATTRS = [
			COMPOSER_ATTR,
			"data-dsh-fairy-composer-row",
			"data-dsh-fairy-composer-tools",
		...
		function mountComposerDock(controller) {
			...
			const ensureMascotAnimationSpeedBase = () => {
				...
				removeMascotAnimationSpeedBase();
				mascotAnimationSpeedBase = createMascotAnimationSpeedBase(card, controller);
			};
			...
			const syncComposerPopoverLayer = () => {
				if (!seat) return;
				if (Boolean(seat.querySelector("[role=\"menu\"], [role=\"listbox\"]"))) seat.setAttribute("data-dsh-fairy-composer-popover", "true");
...
//#region src/client/mascot-runtime.js
	var require_mascot_runtime = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		const { SPEED_EVENT } = require_mascot_animation_speed_control();
...
//#region src/client/workshop.js
	var require_workshop = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		function describeMcp(mcp) {
			if (!mcp?.wired) return {
				ok: false,
				text: "MCP：未接入——重跑一键安装器即会自动补上（scripts/install.mjs）"
			};
			if (mcp.installed === false) return {
				ok: false,
				text: `MCP：已接入但记录的路径已失效——重跑一键安装器重新指向当前安装（${mcp.recorded?.split("\\").pop() ?? "旧路径"}）`
			};
			if (mcp.installed === true) return {
				ok: true,
				text: "MCP：已接入 web profile（用前：Pen 在运行且打开着 .pen）"
			};
			return {
				ok: true,
				text: "MCP：已接入 web profile（路径未记录，无法核对是否失效）"
			};
		}
		function Workshop() {
...
//#region src/client/index.js
	var require_client = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		const { claimStageGeometryLifecycle, claimContentFadeLifecycle } = require_stage_lifecycle();
