...
html[data-dsh-fairy-visual] body :where(.dsh-fairy-session-metrics-panel,.dsh-fairy-session-metrics-item){font-weight:800!important}html[data-dsh-fairy-visual] body :where(pre,code,kbd,samp),html[data-dsh-fairy-visual] body :where(pre,code,kbd,samp) *{font-weight:400!important}html[data-dsh-fairy-visual] body :where(.dsh-fairy-hero-main,.dsh-fairy-mark-title,.dsh-fairy-toggle){font-weight:750!important}`);
		...
		appendSection(`html[data-dsh-fairy-visual] [data-dsh-fairy-composer-dock="true"] [data-dsh-fairy-mascot-animation-speed-control="true"]{background:linear-gradient(#30353a,#30353a)!important;box-shadow:inset 0 1px 2px rgba(255,255,255,.12),inset 0 -1px 2px rgba(0,0,0,.42)!important}html[data-dsh-fairy-visual][data-dsh-fairy-theme="light"] [data-dsh-fairy-composer-dock="true"] [data-dsh-fairy-mascot-animation-speed-control="true"]{background:linear-gradient(#f4f5f6,#f4f5f6)!important;box-shadow:inset 0 1px 2px rgba(255,255,255,.52),inset 0 -1px 2px rgba(52,63,73,.22)!important}`);
		...
		appendSection(`html[data-dsh-fairy-visual]{--dsh-fairy-keycap-face:#30353a;--dsh-fairy-keycap-edge:linear-gradient(135deg,#555f68 0%,#4e5861 48%,#3d444b 100%);--dsh-fairy-keycap-text:#f4f7fb;--dsh-fairy-keycap-hover:#cfe8ff;--dsh-fairy-keycap-radius:8px;--dsh-fairy-keycap-shadow:-4px -4px 9px rgba(255,255,255,.06),5px 6px 13px rgba(0,0,0,.13),inset 1px 1px 0 rgba(255,255,255,.03),inset -1px -1px 0 rgba(0,0,0,.13)}html[data-dsh-fairy-visual] [data-dsh-fairy-keycap="true"]{box-sizing:border-box!important;border-style:solid!important;border-width:2px!important;border-color:transparent!important;border-radius:var(--dsh-fairy-keycap-radius)!important;background:linear-gradient(var(--dsh-fairy-keycap-face),var(--dsh-fairy-keycap-face)) padding-box,var(--dsh-fairy-keycap-edge) border-box!important;color:var(--dsh-fairy-keycap-text)!important;box-shadow:var(--dsh-fairy-keycap-shadow)!important}html[data-dsh-fairy-visual] [data-dsh-fairy-keycap="true"]:hover:not(:disabled){color:var(--dsh-fairy-keycap-hover)!important}`);
