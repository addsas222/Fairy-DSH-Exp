...
node --check "$DSH_ROOT/fairy-memory/dsh-fairy-memory/lib/index.js"
...
node --check "$DSH_ROOT/fairy-eval/dsh-fairy-eval/lib/index.js"
node --check "$DSH_ROOT/fairy-eval/dsh-fairy-eval/lib/engine.js"
...
node --test "$DSH_ROOT/fairy-eval/dsh-fairy-eval/test"/*.test.js
